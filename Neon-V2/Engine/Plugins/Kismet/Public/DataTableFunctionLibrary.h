...
public:
                                       ...
                                       const FString &ContextString = FString(), EEvaluateCurveTableResult *OutResult = nullptr)
    {
        ...
        static SDK::FFunctionInfo Info = SDK::PropLibrary->GetFunctionByName("DataTableFunctionLibrary", "EvaluateCurveTableRow");
        ...
        if (!Object)
            Object = SDK::StaticClassImpl("DataTableFunctionLibrary")->GetClassDefaultObject();
